...
* @returns {Stats}
*/
export function simulate(iters, villager_setup, enemy_setup, start_time, month_length) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.simulate(retptr, iters, addHeapObject(villager_setup), addHeapObject(enemy_setup), start_time, month_length);
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('stacklands_combat_simulator_bg.wasm', import.meta.url);
    }
    const imports = getImports();
